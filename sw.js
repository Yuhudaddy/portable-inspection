const CACHE_NAME = "portable-inspection-v103";
// 範例 PDF（共約 8MB）不放進 shell：每次升版都要整批重抓，手機上安裝又慢又容易失敗；範例本來就需要連線。
const APP_SHELL = ["./", "./404", "./glass.css", "./portal.css", "./portal.js", "./sw-client.js", "./draft.js", "./print-pages.js", "./dialog-forms.js", "./bar-sizes.js", "./rebar-cage.js", "./plan", "./plan.js", "./plan.css", "./plans/diaphragm-wall.js", "./plans/formwork.js", "./plans/rebar.js", "./plans/steel.js", "./example", "./example.css", "./example.js", "./diaphragm-wall", "./diaphragm-wall-gc", "./wall-gc.js", "./app.css", "./app.js", "./template", "./template.css", "./template.js", "./rebar", "./rebar.css", "./rebar.js", "./steel-structure", "./steel.css", "./steel.js", "./record", "./checklists", "./manifest.webmanifest", "./app-icon-144.png", "./apple-touch-icon.png", "./icon-192.png", "./taisei.png"];
